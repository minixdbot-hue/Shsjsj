...
export default {
  ...
  owner: process.env.OWNER_NUMBER || "554488138425",
  sudo: process.env.SUDO || "554488138425",
  packname: process.env.PACKNAME || "𝚀𝚄𝙴𝙴𝙽 𝙰𝙺𝚄𝙼𝙰",
  author: process.env.AUTHOR || "𝙸𝙽𝙲𝙾𝙽𝙽𝚄 𝙱𝙾𝚈",
